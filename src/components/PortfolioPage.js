	...
	return (
		<div className="portfolio-page">
			...
			{props.id === 'calculator' ? 
				...
				:
				<video src={props.video} className="portfolio-page__media" autoPlay="true" controls />
			}

			{props.id === 'joanne-site' && 
			<Text title={props.title}> 
				<div>
					Joanne Evans is a British born opera singer currently studying a master’s degree in Opera at the Manhattan School of Music. She also happens to be my sister and I thought I'd make her a <a className="link" href="https://paule89123.github.io/Joanne-site/index.html" target="_blank" rel="noopener">website</a> as a Christmas present.
					<br /><br />
					Given the subject matter, I tried to keep the design of the site minimalist and classical, without too many distractions and using plenty of white space to keep the site feeling light and airy. 
					<br /><br />
			...
			<Text title={props.title}> 
				<div>
					<a className="link" href="https://paule89123.github.io/coverful/" target="_blank" rel="noopener">Coverful</a> is an e-commerce website that sells cushion covers, with a selection of over 1200 different designs.
					<br /><br />
			...
			<Text title={props.title}> 
				<div>
					<a className="link" href="https://paule89123.github.io/reminders-app/" target="_blank" rel="noopener">Reminders</a> is a fairly simple web app I made with React as an exercise to get to grips with using state.
					<br /><br />
			...
			<Text title={props.title}> 
				<div>
					I made <a className="link" href="https://paule89123.github.io/calculator/" target="_blank" rel="noopener">this calculator</a> as an exercise when learning Javascript. One of the things that I found interesting about this exercise was that the majority of the code was only needed to prevent bugs or unwanted behaviour (such as preventing multiple presses of the operator buttons).
					<br /><br />
